...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/me/tools/memory_manager.py --action read --section 决策档案 --data-dir ${CLAUDE_PLUGIN_ROOT}/skills/me/data
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/me/tools/csv_manager.py --action query --file {log} --format json --data-dir ${CLAUDE_PLUGIN_ROOT}/skills/me/data
```
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/me/tools/memory_manager.py --action append-section --section 决策档案 --content '{决策记录}' --data-dir ${CLAUDE_PLUGIN_ROOT}/skills/me/data
```